...
\begin{questions}
  ...
  \newpage
  \question
  Let $r_1$ and $r_2$ be the roots of the polynomial $p(x) = x^2 + (2 + \epsilon)x^2 + 1$. Compute the condition number $\kappa_{r_1}(\epsilon)$. Simplify the denominator so that it's expressed entirely in terms of $r_1$ and $r_2$.
  ...
  \begin{solution}
    ...
    Therefore:
    $$\kappa_{r_1}(\epsilon) = \left|\frac{\epsilon}{r_1} \cdot \frac{\partial r_1}{\partial \epsilon}\right| = \left|\frac{\epsilon}{r_1} \cdot \left(-\frac{r_1}{r_1-r_2}\right)\right| = \left|\frac{\epsilon}{r_1-r_2}\right|.$$
  \end{solution}
